using Exercicios_DOO.BehavioursPatterns.ChainOfResponsability;
using Exercicios_DOO.BehavioursPatterns.Command;
using Exercicios_DOO.BehavioursPatterns.Interpreter;
using Exercicios_DOO.BehavioursPatterns.Iterator;
using Exercicios_DOO.BehavioursPatterns.Mediator;
using Exercicios_DOO.BehavioursPatterns.Memento;
using Exercicios_DOO.BehavioursPatterns.Observer;
using Exercicios_DOO.BehavioursPatterns.State;
using Exercicios_DOO.BehavioursPatterns.Strategy;
using Exercicios_DOO.BehavioursPatterns.TemplateMethod;
using Exercicios_DOO.BehavioursPatterns.Visitor;
