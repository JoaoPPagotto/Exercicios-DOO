using Exercicios_DOO.StructuralPatterns.AddapterPattern;
using Exercicios_DOO.StructuralPatterns.BridgePattern;
using Exercicios_DOO.StructuralPatterns.CompositePattern;
using Exercicios_DOO.StructuralPatterns.DecoratorPattern;
using Exercicios_DOO.StructuralPatterns.FacadePattern;
using Exercicios_DOO.StructuralPatterns.FlyWeightPattern;
using Exercicios_DOO.StructuralPatterns.ProxyPattern;
...
namespace StructuralPatterns
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n# PADRÃO FACADE\n");
            var homeTheater = new HomeTheater(new DvdPlayer(), new Projector(), new Lights(), new SoundSystem());
